...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2023 at 02:39 AM
...
(2, 'Mesin Cuci bekas bill gates', '2023-05-24', 12000000, 'Mesin cuci baru dipakai sekali sama bill gates, struk pembeliannya juga masih ada', '646f6606c10b4.jpg', '646f6606c15c5.jpg', '646f6606c1849.jpg'),
...
(7, 'AC buatan orang merkurius', '2023-05-26', 2000000, 'AC yang super duper limited edition', '646fd533e7aab.jpg', '646fd533e8633.jpg', '646fd533e8bc8.jpg'),
(9, 'Kipas bekas elon musk limited edition', '2023-05-26', 20000000, 'Bekas dipake elon musk', '6470143232650.jpg', '6470143232bbf.jpg', '64701432335c2.jpg');
...
(4, 4, 8, 20000000, 30000000, '2023-05-26');
...
(15, 7, 7, 1, '2023-05-26', 3000000),
(16, 8, 9, 1, '2023-05-26', 25000000),
(17, 8, 9, 6, '2023-05-26', 30000000);
...
(1, 'Zainandhi Nur Fathurrohman', 'Zainandhi', '111', '08817801129', 'zainandhif@gmail.com', '646fd4788cbc3.jpg'),
...
(5, 'Burhan', 'Burhan', '123', '0886662323', 'Indra@gmail.com', 'profile.png'),
...
(7, 7, '2023-05-26', '2023-05-31', 2000000, 3000000, 1, 27, 'dibuka'),
(8, 9, '2023-05-26', '2023-05-31', 20000000, 30000000, 6, 27, 'dicheckout');
...
(1, 'Dimas Adriansyah', 'dimas', '111', 1, '6470106cf2746.jpg'),
...
(36, 'test', 'test', '111', 2, '646fd85bc74e0.jpg');
...
(4, '202305260004', 6, 27, '2023-05-26', 'Mana mana', 'Jalan Kebenaran', 'express', 'Transfer-Bank', '088823892832', 30000000, 100000, 5000, 30105000);
...
--
ALTER TABLE `tdetailtransaksi`
  MODIFY `id_detailtransaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
